...
public class PersonDAO extends DAO<User> {
    ...
    public void insertRecord(User user) throws SQLException {
        ...
        PreparedStatement prepStatement = con.prepareStatement("INSERT INTO person (username, passwd_hash, salt, name, " +
                "last_name, role, email, phone) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        prepStatement.setInt(6, user.getRole());
        prepStatement.setString(7, user.getEmail());
        prepStatement.setString(8, user.getPhone());
